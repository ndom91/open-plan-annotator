      ...
      <div className="flex items-center gap-2">
        {hasPreviousVersion && (
          <button
            ...
            className={cn(
              "px-2.5 py-1.5 rounded-md text-xs font-medium transition-colors focus-visible:ring-2 focus-visible:ring-margin-note/50",
        ...
        <button
          type="button"
          onClick={toggle}
          className="p-2 rounded-md text-ink-tertiary hover:text-ink-secondary hover:bg-ink/5 transition-colors focus-visible:ring-2 focus-visible:ring-margin-note/50"
          title="Toggle theme"
        ...
        <button
          ...
          className="px-3 py-1.5 rounded-md text-[13px] font-medium text-redline hover:bg-redline-bg disabled:opacity-30 disabled:cursor-not-allowed transition-colors focus-visible:ring-2 focus-visible:ring-margin-note/50"
          title="⌘⇧↵"
        >
          Send Annotations
        </button>
        <button
          ...
          onClick={approve}
          disabled={isPending}
          className="px-3.5 py-1.5 rounded-md bg-approve hover:bg-approve-hover disabled:opacity-30 disabled:cursor-not-allowed text-white text-[13px] font-medium transition-colors focus-visible:ring-2 focus-visible:ring-margin-note/50"
          title="⌘↵"
        >
          Accept Plan
        </button>
